...
export const WIDGET_REGISTRY = {
    ...
    clock: { component: ClockCard, label: "Clock", defaultSize: "small", description: "Displays the current time." },
    ...
    collections: { component: OwnedCollectionsCard, label: "Owned Collections", defaultSize: "medium", description: "Shows owned collections." },
    favoritedCollections: { component: FavoritedCollectionsCard, label: "Favorited Collections", defaultSize: "medium", description: "Shows favorited collections." },
