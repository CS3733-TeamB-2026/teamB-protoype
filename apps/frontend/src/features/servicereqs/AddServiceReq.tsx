...
/**
 * Old Add Employee Code, no touchy
 */
                ...
                {/*This does the border around the screen*/}
                    ...
                    <>
                        ...
                        <div className="flex justify-center bg-background py-4">
                            <Button onClick={handleSubmit} className="bg-accent text-lg text-white hover:bg-accent-dark hover:text-white px-10 py-6" variant="outline" size="lg">
                                Submit
                            </Button>
                        </div>
                        </>
