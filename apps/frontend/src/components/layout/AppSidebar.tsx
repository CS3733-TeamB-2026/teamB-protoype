...
const navItems: NavItem[] = [
    ...
    { title: "Manage Content", icon: Library, href: "/", children: [
            { title: "View Content", icon: LucideFolders, href: "/files", children: [], access: ["admin", "underwriter", "businessAnalyst"], langKey: 'sidebar.viewContent' },
            { title: "Add Content", icon: FilePlus, href: "/manageform", children: [], access: ["admin", "underwriter", "businessAnalyst"], langKey: 'sidebar.addContent' },
