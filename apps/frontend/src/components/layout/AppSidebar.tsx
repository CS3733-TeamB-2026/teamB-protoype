import { Home, User, ChevronDown, Users, UserPlus, X, Library, UserCog, LayoutDashboard, Upload } from "lucide-react"
...
const navItems: NavItem[] = [
    ...
    { title: "Content Library", icon: Library, href: "/files", children: [], access: ["admin", "underwriter", "businessAnalyst"], langKey: 'sidebar.contentLibrary' },
